...
export default function Dashboard() {
  ...
  // Lift WebRTC connection to Dashboard level to persist session across tabs
  ...
  return (
    <div className="app-container">
      <div className="main-layout">
        ...
        {/* Sidebar navigation */}
        <nav aria-label="Main navigation" className="glass-panel sidebar-nav">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '32px', padding: '0 8px' }}>
            ...
            <span style={{ fontFamily: 'Outfit', fontWeight: 800, fontSize: '1.25rem', letterSpacing: '-0.02em' }} className="nav-text">Phone2Client</span>
          </div>
            ...
            <div style={{ position: 'relative', marginBottom: '24px' }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <span style={{ fontWeight: 550, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '140px' }} className="nav-text">
                    {activeWorkspace.name}
                  </span>
                </div>
                <ChevronDown size={14} color="var(--text-secondary)" className="nav-text" />
              </button>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', flex: 1 }}>
            ...
            >
              <Phone size={18} />
              <span className="nav-text">Keypad Dialer</span>
            </button>
            ...
            >
              ...
              <span className="nav-text">SMS Messaging</span>
            </button>
            ...
            >
              <Binary size={18} />
              <span className="nav-text">Active Numbers</span>
            </button>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '0 8px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden' }} className="nav-text">
        ...
        <div className="content-wrapper">
          ...
          <main className="glass-panel" style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
            {activeTab === 'dialer' && <DialerTab socket={socket} webrtc={webrtc} />}
